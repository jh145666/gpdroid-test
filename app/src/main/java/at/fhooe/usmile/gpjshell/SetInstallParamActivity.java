...
public class SetInstallParamActivity extends AppCompatActivity {
                                ...
                                if (mEditParams.getText() != null && !mEditParams.getText().toString().equals("")
                                        ...
                                        if(mEditParams.getText().toString().length()%2 != 0){
                                                Toast.makeText(SetInstallParamActivity.this,
                                                                "Please check your parameters. Parameters must be a hex value with even number of hex digits.",
