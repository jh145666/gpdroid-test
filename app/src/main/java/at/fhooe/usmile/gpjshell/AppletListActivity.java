 ...
 *     2025 Adaptation - AndroidX migration, removed OpenMobileAPI dependency
 ******************************************************************************/
...
public class AppletListActivity extends AppCompatActivity implements AppletDetailActivity.NoticeAppletEventListener {
        ...
        public void showAppletDetailsDialog(boolean isSd) {
                ...
                dialog.show(getSupportFragmentManager(), "AppletDetailFragment");
