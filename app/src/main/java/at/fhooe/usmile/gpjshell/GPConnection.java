 ...
 *     2025 Adaptation - Removed OpenMobileAPI dependency, use GPTerminal interface
 ******************************************************************************/
...
public class GPConnection {
        ...
        /**
         * Method that acquires a CardChannel from the given GPTerminal and performs
         * the given GPCommand on it.
         * Updated to use GPTerminal interface instead of raw CardTerminal.
         * 
         * @param terminal - the GPTerminal to use (NfcTerminal or other)
         * @param keyset
         * @param channelSet
         * @param _cmd
         * @return
         */
        public String performCommand(GPTerminal terminal, GPKeyset keyset, GPChannelSet channelSet,
                        GPCommand _cmd) {

                try {
                        Card c = null;
                        CardTerminal _term = terminal.getCardTerminal();
